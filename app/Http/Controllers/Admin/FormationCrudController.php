...
class FormationCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Formation::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/formation');
    ...
    {
        CRUD::setValidation(FormationRequest::class);
