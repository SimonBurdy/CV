<template>
    <div class="container-fluid" >
        <div class="row top-bar mt-5">
            <div class="row">
                <div class="col-md-9">
                    <div>
                        <h3 >Burdy Simon</h3>
                        <p>Freelance en développenment Informatique</p>
                    </div>
                    <div>
                        ...
                        standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
                        standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make 
                        a type specimen book. It has </p>
                    </div>   
                </div> 
                <div class="col-md-3 morph text-center mt-2">
                    <div>
                         <img :src="'/img/photoCv.jpg'"  alt="photo de cv" style="max-width: 180px;  ">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div  class="techno row">
                            <div class="col-md-6">
                                <p>HTML5/CSS3/SCSS/Boostrap 5</p>
                            </div>
                            <div class="col-md-6">
                                <div class="col">
                        ...
                        <div  class="techno row">
                            <div class="col-md-6">
                                <p>Javascript/VueJs2/AlpineJs</p>
                            </div>
                               <div class="col-md-6">
                                <div class="col">
                                    <i class="fa fa-star" aria-hidden="true"></i>
...
.vesti-date-wrapper .vesti-date .day {
  font-size: 20px;
  color: #2d3e4f;
  line-height: 0px;
  display: block;
...
.vesti-date-wrapper .vesti-date .month {
  font-size: 12px;
  color: #2d3e4f;
  line-height: 0px;
  display: block;
